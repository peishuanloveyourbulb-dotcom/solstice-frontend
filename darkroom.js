// ============================================
// Sol² 暗房（Darkroom）— darkroom.js v5
      ...
      '<div class="dr-shell">' +
        '<div class="dr-head">' +
          '<div class="dr-hd-left">' +
            ...
            '</div>' +
          '</div>' +
          '<span class="dr-safelight-stk" aria-hidden="true"><svg viewBox="0 0 20 20" style="width:24px;height:24px;display:block"><path d="M10 1.4 v3" stroke="#8C8C96" stroke-width="1.6" stroke-linecap="round"/><path d="M4.6 9.6 a5.4 5.4 0 0 1 10.8 0 z" fill="#FBE4EE" stroke="#8C8C96" stroke-width="1.7" stroke-linejoin="round"/><circle class="dr-bulb" cx="10" cy="12.8" r="3" fill="#E98FAE" stroke="#B76E90" stroke-width="1.2"/></svg></span>' +
        '</div>' +
        '<div class="dr-film" aria-hidden="true"></div>' +
        '<div class="dr-scroll" id="drScroll">' +
          '<div class="dr-doodle" aria-hidden="true"><svg viewBox="0 0 24 24"><g fill="#F3B7CA" stroke="#C9698F" stroke-width="1.2"><ellipse cx="12" cy="5.6" rx="3" ry="4.3"/><ellipse cx="12" cy="5.6" rx="3" ry="4.3" transform="rotate(72 12 12)"/><ellipse cx="12" cy="5.6" rx="3" ry="4.3" transform="rotate(144 12 12)"/><ellipse cx="12" cy="5.6" rx="3" ry="4.3" transform="rotate(216 12 12)"/><ellipse cx="12" cy="5.6" rx="3" ry="4.3" transform="rotate(288 12 12)"/><circle cx="12" cy="12" r="2.6" fill="#FBE4EE"/></g></svg></div>' +
