...
(function () {
  ...
  function drBigCam() {
    return '<svg class="dr-cam" id="drCam" viewBox="0 42 240 178" aria-label="相機寶寶">' +
      ...
      '<rect x="96" y="138" width="48" height="42" rx="2" fill="#FEFEFC" stroke="#CFC7D2" stroke-width="2"/>' +
      '<rect x="100" y="142" width="40" height="26" rx="1" fill="#EADAE2"/>' +
      '<path class="dr-cam-devheart" d="M120 164 c-5,-3.8 -7.2,-6.1 -7.2,-8.9 a4,4 0 0 1 7.2,-2.3 a4,4 0 0 1 7.2,2.3 c0,2.8 -2.2,5.1 -7.2,8.9 z" fill="#E98FAE"/>' +
