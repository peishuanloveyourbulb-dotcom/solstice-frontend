...
(function () {
  ...
  function drBigCam() {
    return '<svg class="dr-cam" id="drCam" viewBox="0 0 240 210" aria-label="相機寶寶">' +
      ...
      '<g class="dr-amb dr-amb2"><path d="M222 54 l1.7 4.3 4.3 1.7 -4.3 1.7 -1.7 4.3 -1.7 -4.3 -4.3 -1.7 4.3 -1.7 z" fill="#F6A9C6" stroke="#D6799F" stroke-width="1.4" stroke-linejoin="round"/></g>' +
      '<g class="dr-amb dr-amb3"><path d="M228 90 c-1.9 -2.3 -5.5 -1.1 -5.5 1.6 c0 2.5 3.3 4.3 5.5 6.1 c2.2 -1.8 5.5 -3.6 5.5 -6.1 c0 -2.7 -3.6 -3.9 -5.5 -1.6 z" fill="#F3A5C0" stroke="#D6799F" stroke-width="1.3" stroke-linejoin="round"/></g>' +
      '<g class="dr-amb dr-amb4"><path d="M18 82 l1.3 3.2 3.2 1.3 -3.2 1.3 -1.3 3.2 -1.3 -3.2 -3.2 -1.3 3.2 -1.3 z" fill="#F6C9D9" stroke="#D98CA9" stroke-width="1.3" stroke-linejoin="round"/></g>' +
      '<defs>' +
  ...
  function wireEvents() {
    ...
    document.addEventListener('visibilitychange', function () { if (document.hidden && drag.on) endDrag(true); }); // 2026/07/21 切出去（通知/截圖分享/切app）當場把拖曳收乾淨
