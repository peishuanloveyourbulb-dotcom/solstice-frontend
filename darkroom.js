    ...
    drPage.innerHTML = '' +
      '<div class="dr-shell">' +
        '<div class="dr-head">' +
          ...
          '<div><div class="dr-title-en">Darkroom</div><div class="dr-title-zh">暗房 · 我們的合照牆</div></div>' +
          '<div class="dr-safelight" aria-hidden="true"></div>' +
        '</div>' +
