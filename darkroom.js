...
(function () {
  ...
  function drBigCam() {
    return '<svg class="dr-cam" id="drCam" viewBox="0 0 240 210" aria-label="相機寶寶">' +
      ...
      '<g class="dr-amb dr-amb2"><path d="M222 54 l1.7 4.3 4.3 1.7 -4.3 1.7 -1.7 4.3 -1.7 -4.3 -4.3 -1.7 4.3 -1.7 z" fill="#F6A9C6" stroke="#E98FAE" stroke-width="1.4" stroke-linejoin="round"/></g>' +
      ...
      '<g class="dr-amb dr-amb4"><path d="M18 82 l1.3 3.2 3.2 1.3 -3.2 1.3 -1.3 3.2 -1.3 -3.2 -3.2 -1.3 3.2 -1.3 z" fill="#F6C9D9" stroke="#E9A0BC" stroke-width="1.3" stroke-linejoin="round"/></g>' +
      '<defs>' +
