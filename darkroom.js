// ============================================
// Sol² 暗房（Darkroom）— darkroom.js v8
// 照片先壓縮再進門（長邊1200 / 品質0.85），
// 取下走兩段式：倉庫實體檔→登記簿，一起徹底清掉 💚
// v8：全面對齊全家選單語言（英文草寫標題＋愛心貼紙＋吉祥物會動會眨眼），
// 修好拖曳分身被壓在房間底下的 z-index bug，門口貼紙換成底片罐小傢伙
// ============================================
(function () {
  'use strict';
      ...
      '<div class="dr-shell">' +
        '<div class="dr-head">' +
          '<div class="dr-hd-left">' +
            ...
            '</div>' +
          '</div>' +
          '<span class="dr-safelight-stk" aria-hidden="true"><svg viewBox="0 0 32 34" style="width:27px;height:29px;display:block"><rect x="12.5" y="1.5" width="7" height="4" rx="1.6" fill="#8C8C96"/><rect x="6.5" y="4.5" width="19" height="5.5" rx="2.4" fill="#F3B7CA" stroke="#C9698F" stroke-width="1.5"/><path d="M24 15 h6.2 v7 h-6.2" fill="#2A2A31" stroke="#8C8C96" stroke-width="1.4" stroke-linejoin="round"/><rect x="26.3" y="16.7" width="2" height="1.5" rx="0.4" fill="#FBF9F4"/><rect x="26.3" y="18.9" width="2" height="1.5" rx="0.4" fill="#FBF9F4"/><rect x="8" y="9" width="16" height="21" rx="3.5" fill="#FBF9F4" stroke="#8C8C96" stroke-width="1.8"/><circle class="dr-eye" cx="13.4" cy="17.5" r="1" fill="#6E5A60"/><circle class="dr-eye" cx="18.6" cy="17.5" r="1" fill="#6E5A60"/><path d="M13.8 20.2 q2.2 1.8 4.4 0" fill="none" stroke="#6E5A60" stroke-width="1.2" stroke-linecap="round"/><circle cx="11" cy="19.4" r="1" fill="#F0A5BE"/><circle cx="21" cy="19.4" r="1" fill="#F0A5BE"/><path d="M16 24.4 c-0.9 -1.3 -2.6 -0.5 -2.6 0.8 c0 1.2 1.7 2 2.6 2.7 c0.9 -0.7 2.6 -1.5 2.6 -2.7 c0 -1.3 -1.7 -2.1 -2.6 -0.8 z" fill="#E98FAE" stroke="#C9698F" stroke-width="0.9"/></svg></span>' +
        '</div>' +
